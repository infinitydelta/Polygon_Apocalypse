...
4. Right click to pick different tile types
5. Press ESCAPE or select another object in the hierarchy when finished

IMPORTANTE NOTE: If Unity asks to "fix" the included normal maps click "ignore", otherwise they will not work
